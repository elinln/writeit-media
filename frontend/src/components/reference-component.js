    ...
    render() {
        return (
            <div>
                ...
                <div style={{ display: "flex", justifyContent: "center", flexDirection: "row", marginLeft: "15%", padding: "3%", width: "70%", backgroundColor: "rgb(235 172 36 / 49%)", alignItems: "center", color: "white", fontSize: "20px" }}>
